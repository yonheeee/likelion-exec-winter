window.onload   =   function   ()   {
    ...
    `${monthList[firstDate.getMonth()]}&nbsp;&nbsp;&nbsp;&nbsp;${today.getFullYear()}`;
    ...
    //따라   출력해   준   후,   달력   출력   종료조건이다.
                            if    (i    ===    0    &&    j    <    firstDate.getDay()    ||    Currentdate    >   
    pageYear[firstDate.getMonth()])   {
    ...
    function   currentDateget()   {      //   format()을   이용해서   현재   날짜를   보기좋게   출력해주기   위해   사용.
